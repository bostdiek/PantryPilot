      ...
      <div className="p-4">
        ...
        <div className="mb-3">
          {hasRecipe && onRecipeClick ? (
            ...
            >
              <h3 className="text-lg leading-tight font-semibold break-words text-gray-900 group-hover:text-blue-700">
                {label}
              </h3>
            </button>
          ) : (
            <h3 className="text-lg leading-tight font-semibold break-words text-gray-900">
              {label}
            </h3>
          )}
